...
# TODO: complete and adjust calibration coefficients for
# metop2, noaa 10, 11, 12, 15, 16
...
coeffs = {
    ...
    'noaa10': {'ah': np.array([0.114803, 0.13268199999999999, 0.0]),
               'al': np.array([0.114803, 0.13268199999999999, 0.0]),
               'bh': np.array([3.4345599999999998, 0.00926103, 0.0]),
               'bl': np.array([3.4345599999999998, 0.00926103, 0.0]),
               'c_dark': np.array([39.439999999999998,
                                   39.399999999999999,
                                   37.509999999999998]),
               'ch': np.array([-0.384635, 0.13733300000000001, 0.0]),
               'cl': np.array([-0.384635, 0.13733300000000001, 0.0]),
               'l_date': 1986.712,
               'd': np.array([[0, 0, 0, 0, 0],  # reset prt
    ...
    'noaa11': {'ah': np.array([0.114786, 0.115219, 0.0]),
               ...
               'bh': np.array([-1.8297399999999999, -1.3949499999999999, 0.0]),
               'bl': np.array([-1.8297399999999999, -1.3949499999999999, 0.0]),
               'c_dark': np.array([40.0, 40.0, 40.0]),
               'ch': np.array([0.412551, 0.23697799999999999, 0.0]),
               'cl': np.array([0.412551, 0.23697799999999999, 0.0]),
               'l_date': 1988.7064,
               'd': np.array([[0, 0, 0, 0, 0],  # reset prt
    ...
    'noaa12': {'ah': np.array([0.118059, 0.135684, 0.0]),
               ...
               'bh': np.array([4.8884800000000004, 4.6709800000000001, 0.0]),
               'bl': np.array([4.8884800000000004, 4.6709800000000001, 0.0]),
               'c_dark': np.array([41.0, 40.0, 40.0]),
               'ch': np.array([-0.34776899999999999, -0.399447, 0.0]),
               'cl': np.array([-0.34776899999999999, -0.399447, 0.0]),
               'l_date': 1991.3669,
               'd': np.array([[0, 0, 0, 0, 0],  # reset prt
                              [276.597, 0.051275, 1.363e-06, 0, 0],
                              [276.597, 0.051275, 1.363e-06, 0, 0],
    ...
    'noaa15': {'ah': np.array([0.18149999999999999,
                               0.20250000000000001,
                               0.18459999999999999]),
               'al': np.array([0.060499999999999998, 0.067500000000000004, 0.0275]),
               'bh': np.array([0.44700000000000001, 0.035000000000000003, 0.0]),
               'bl': np.array([0.44700000000000001, 0.035000000000000003, 0.0]),
               'c_dark': np.array([39.0, 40.0, 39.0]),
               'c_s': np.array([500.0, 500.0, 500.0]),
               'ch': np.array([-0.059999999999999998, 0.0070000000000000001, 0.0]),
               'cl': np.array([-0.059999999999999998, 0.0070000000000000001, 0.0]),
               'l_date': 1998.3641,
               'd': np.array([[0, 0, 0, 0, 0],  # reset prt
    ...
    'noaa16': {'ah': np.array([0.168, 0.174, 0.2013]),
               ...
               'bl': np.array([0.30599999999999999,
                               0.58599999999999997,
                               -0.81000000000000005]),
               'c_dark': np.array([39.299999999999997,
                                   38.899999999999999,
                                   38.399999999999999]),
               'c_s': np.array([498.95999999999998,
                                500.17000000000002,
                                499.43000000000001]),
               'ch': np.array([0.0250, 0.035999999999999997, 0.0]),
               'cl': np.array([0.0250, 0.035999999999999997, 0.0]),
               'l_date': 2000.7228,
               'd': np.array([[0, 0, 0, 0, 0],  # reset prt
