...
coeffs = {
    ...
    'noaa14': {'ah': [0.121408, 0.144515, 0.0],
               ...
               'bh': [4.0731299999999999, 0.88533099999999998, 0.0],
               'bl': [4.0731299999999999, 0.88533099999999998, 0.0],
               'c_dark': [41.0, 41.0, 39.0],
               'ch': [-0.37521500000000002, 0.23372699999999999, 0.0],
               'cl': [-0.37521500000000002, 0.23372699999999999, 0.0],
               'l_date': 1994.9699000000001,
               'd1': [276.597, 0.051275, 1.363e-06],
               'd2': [276.597, 0.051275, 1.363e-06],
               'd3': [276.597, 0.051275, 1.363e-06],
               'd4': [276.597, 0.051275, 1.363e-06],
               'd': np.array([[0, 0, 0],  # reset prt
                              [276.597, 0.051275, 1.363e-06],
                              [276.597, 0.051275, 1.363e-06],
                              [276.597, 0.051275, 1.363e-06],
                              [276.597, 0.051275, 1.363e-06]]),
...
def calibrate_thermal(counts, prt, ict, space, line_numbers, channel, spacecraft):
    ...
    tprt = cal.d[iprt, 0] + prt * (cal.d[iprt, 1] + prt * cal.d[iprt, 2])
