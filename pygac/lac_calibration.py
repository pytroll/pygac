...
coeffs = {
	'metop01': {'ah': [0.179, 0.174, 0.247],
                'al': [0.060, 0.058, 0.035],
                'bh': [-7.442, 10.222, -27.970],
                'bl': [-7.442, 10.222, -27.970],                
                'ch': [2.828, -3.271, 10.925],
                'cl': [2.828, -3.271, 10.925],
    ...
    'metop02': {'ah': [0.167, 0.199, 0.220],
                'al': [0.056, 0.066, 0.031],
                'bh': [0.906, 0.814, 2.020],
                'bl': [0.906, 0.814, 2.020],                
                'ch': [-0.024, 0.025, -0.115],
                'cl': [-0.024, 0.025, -0.115],
				'c_dark': [40.43, 39.75, 41.8],
                'c_s': [501.0, 500.0, 502.0],
                'l_date': 2006.77,
                'd': np.array([[0, 0, 0, 0, 0],  # reset prt
